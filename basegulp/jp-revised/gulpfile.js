...
gulp.task('inject', ['styles', 'templatecache'], function(done) {
    log('TODO: inline this task into its callers, ensuring the dependant tasks run and then the containing task');
